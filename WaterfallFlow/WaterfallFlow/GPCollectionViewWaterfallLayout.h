 ...
 */
typedef NS_ENUM (NSUInteger, GPCollectionViewWaterfallLayoutItemRenderDirection) {
  GPCollectionViewWaterfallLayoutItemRenderDirectionShortestFirst,
  GPCollectionViewWaterfallLayoutItemRenderDirectionLeftToRight,
  GPCollectionViewWaterfallLayoutItemRenderDirectionRightToLeft
};
...
extern NSString *const GPCollectionElementKindSectionHeader;
/// A supplementary view that identifies the footer for a given section.
extern NSString *const GPCollectionElementKindSectionFooter;

#pragma mark - GPCollectionViewDelegateWaterfallLayout

@class GPCollectionViewWaterfallLayout;

/**
 *  The GPCollectionViewDelegateWaterfallLayout protocol defines methods that let you coordinate with a
 *  GPCollectionViewWaterfallLayout object to implement a waterfall-based layout.
 ...
 */
@protocol GPCollectionViewDelegateWaterfallLayout <UICollectionViewDelegate>
@required
/**
...
#pragma mark - GPCollectionViewWaterfallLayout

/**
 *  The GPCollectionViewWaterfallLayout class is a concrete layout object that organizes items into waterfall-based grids
 ...
 *  in each section. That delegate object must conform to the `GPCollectionViewDelegateWaterfallLayout` protocol.
 *
 ...
 *
 *  @note GPCollectionViewWaterfallLayout doesn't support decoration view, and it supports vertical scrolling direction only.
 */
@interface GPCollectionViewWaterfallLayout : UICollectionViewLayout
 ...
 *  @discussion
 *    The direction in which each item is rendered. This could be left to right (GPCollectionViewWaterfallLayoutItemRenderDirectionLeftToRight), right to left (GPCollectionViewWaterfallLayoutItemRenderDirectionRightToLeft), or shortest column fills first (GPCollectionViewWaterfallLayoutItemRenderDirectionShortestFirst).
 *
 *    Default: GPCollectionViewWaterfallLayoutItemRenderDirectionShortestFirst
 */
@property (nonatomic, assign) GPCollectionViewWaterfallLayoutItemRenderDirection itemRenderDirection;
